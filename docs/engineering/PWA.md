...
2026-09-13 · PWA와 Firebase 인증·계정 저장을 구현했고 사용자가 Vercel에 배포했다. 설치형 웹이며 앱 스토어 등록이나 네이티브 앱 개발 완료를 뜻하지 않는다. Google 팝업 포커스 변경과 iPhone 실기기 확인 범위는 [작업 로그](../delivery/WORK_LOG.md)를 따른다.
