...
- 경기 북서부(고양·파주·양주)를 1차 제품 탐색·후속 검수 지역으로 정한다. 수요와 공식 데이터 비교 근거는 [지역 선정](data/REGION_SELECTION_2026-09-16.md)에 있다. 인천 검색·시 자료 검수 자산은 유지하며, 새 권역의 규정 완전성·대체 후보 검증은 진행 단계다.
