...
채택한 구현 방향은 Next.js 기반 모바일 웹이며, 무료 호스팅·DB와 현재 code-server 개발 환경을 반영한다. 구체적 선택은 [기술 스택](../engineering/STACK_DECISION.md)에서 관리한다. 사용자가 제공한 ref/의 디자인 레퍼런스는 [DESIGN.md](../../DESIGN.md)에 반영했다. 새 도메인 구매 여부는 사용자가 결정한다.
