...
이용 불가 방문지가 생기면 실제 장소와 가상 체험 모두 대체 후보를 비교해볼 수 있습니다. 후보는 이용 가능·준비 필요·확인 필요 상태로 구분해 보여주며, 선택한 후보를 코스에 반영한 뒤 전체 일정을 다시 검사합니다. 준비 필요·확인 필요 장소는 기존 장소를 유지하면서 확인·준비할 수 있도록 대체 버튼을 보여주지 않습니다.
